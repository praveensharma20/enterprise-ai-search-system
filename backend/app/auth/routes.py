...
def get_database():
    ...
    try:
        ...
        logger.warning(f"Failed to connect using MONGODB_URL '{mongodb_url}': {e}. Falling back to localhost.")
        try:
            ...
            logger.error(f"Could not establish any MongoDB connection: {e2}")
            raise
